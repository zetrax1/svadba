...
const SCRIPT_ENDPOINT = 'https://script.google.com/macros/s/AKfycbwNrrTBxWmE5dYDIvH-wfp365nOs7xtoEAFNBDDyPYrwYS2WH3Jhn2WZH78NHR1DM_8/exec'
      ...
      <div className="container">
        ...
        <div className="rsvp__wizard">
          <div className="rsvp__dots">
            {dotSteps.map((s) => (
              <div key={s} className={
                `rsvp__dot${s === step ? ' rsvp__dot--active' : ''}${dotSteps.indexOf(s) < dotSteps.indexOf(step) ? ' rsvp__dot--done' : ''}`
              } />
            ))}
          </div>
